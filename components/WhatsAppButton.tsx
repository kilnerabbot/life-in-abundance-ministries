...
export default function WhatsAppButton() {
  ...
  return (
    <a
      ...
      aria-label="Chat with Life in Abundance Ministries on WhatsApp"
      className="group fixed bottom-5 right-5 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-[#25D366] text-white shadow-lg shadow-black/20 transition-transform hover:scale-110 focus-visible:scale-110"
    >
      ...
      <span className="pointer-events-none absolute right-full mr-3 hidden whitespace-nowrap rounded-lg bg-abundance-night px-3 py-1.5 font-body text-xs text-white opacity-0 shadow-lg transition-opacity group-hover:opacity-100 md:block">
        Chat with us
      </span>
    </a>
  );
